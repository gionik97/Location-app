...
import { setSearchQuery, addRecentSearch } from "../redux/location";
...
function Search() {
  ...
  const [wrongIPAdress, setWrongIPAdress] = useState("");
  ...
  const handleSearch = () => {
    ...
    if (regex.test(search)) {
      ...
      setWrongIPAdress("Wrong IP Adress");
    ...
    <>
      <Box sx={{ height: "40px", display: "flex" }}>
        <TextField
          ...
          placeholder="search by IP adress or URL"
          variant="filled"
          size="small"
